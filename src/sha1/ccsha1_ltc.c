...
static void sha1_compress(ccdigest_state_t state, size_t nblocks, const void *buf)
{
    ...
    /* compress */
    /* round one */
    #define FF0(a,b,c,d,e,i) e = (CC_ROLc(a, 5) + F0(b,c,d) + e + W[i] + 0x5a827999UL); b = CC_ROLc(b, 30);
    #define FF1(a,b,c,d,e,i) e = (CC_ROLc(a, 5) + F1(b,c,d) + e + W[i] + 0x6ed9eba1UL); b = CC_ROLc(b, 30);
    #define FF2(a,b,c,d,e,i) e = (CC_ROLc(a, 5) + F2(b,c,d) + e + W[i] + 0x8f1bbcdcUL); b = CC_ROLc(b, 30);
    #define FF3(a,b,c,d,e,i) e = (CC_ROLc(a, 5) + F3(b,c,d) + e + W[i] + 0xca62c1d6UL); b = CC_ROLc(b, 30);
