...
#define Te0(x) TE0[x]
#define Te1(x) CC_RORc(TE0[x], 8)
#define Te2(x) CC_RORc(TE0[x], 16)
#define Te3(x) CC_RORc(TE0[x], 24)

#define Td0(x) TD0[x]
#define Td1(x) CC_RORc(TD0[x], 8)
#define Td2(x) CC_RORc(TD0[x], 16)
#define Td3(x) CC_RORc(TD0[x], 24)
